...
AddEventHandler('projektsantos:wiezienie', function(source, czas, powod, grzywna)
		...
		TriggerEvent("esx_jailer:sendToJail", source, czas, powod)
...
AddEventHandler('insertKarto', function(data)
	MySQL.Async.execute('INSERT INTO kartoteka (firstname, lastname, dateofbirth, verdict, reason, cop) VALUES (@firstname, @lastname, @dateofbirth, @verdict, @reason, @cop)', 
	{
